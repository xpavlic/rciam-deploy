-- ALL VARIABLES FILLED WITH REAL VALUES BY
-- Jan Pavlíček (xpavli95@stud.fit.vutbr.cz)


INSERT INTO tenants (name,client_id,client_secret,issuer_url,base_url)
VALUES ('cesnet','37a33acf-8d0a-42b0-9e81-eb3f5a2341db','<ANONYMIZED>','https://login.e-infra.cz/oidc','https://federation-registry.dev.perun-aai.org/cesnet');
